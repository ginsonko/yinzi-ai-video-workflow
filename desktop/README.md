...
- `银子AI视频工作流-通用版-老李兼容-Setup-0.1.4-x64.exe`
- `银子AI视频工作流-通用版-老李兼容-Portable-0.1.4-x64.exe`
- `银子AI视频工作流-通用版-老李兼容-0.1.4-mac-arm64.dmg` 与同名 ZIP
- `银子AI视频工作流-通用版-老李兼容-0.1.4-mac-x64.dmg` 与同名 ZIP
...
- `银子AI视频工作流-通用版-老李兼容-0.1.4-mac-arm64.dmg` 与同名 ZIP：Apple Silicon（M1/M2/M3/M4 及后续）。
- `银子AI视频工作流-通用版-老李兼容-0.1.4-mac-x64.dmg` 与同名 ZIP：Intel Mac。
